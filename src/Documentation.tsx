...
const screens = [
    ...
    },
    {
        ...
        decisions: [
            ...
            "Review Again sends card back into deck. Next Card advances. No spaced-repetition scoring (not in current dataset).",
        ],
    },
    {
        id: "S5",
                                    ...
                                    <table style={{ width: "100%", fontSize: 13, borderCollapse: "collapse" }}>
                                        <thead>
                                            <tr style={{ borderBottom: `1px solid ${BORDER}` }}>
                                                {["Screen", "Orientation", "Module", "Status"].map(h => <th key={h} style={{ textAlign: "left", padding: "6px 12px 10px", fontSize: 11, color: MUTED, fontWeight: 600, textTransform: "uppercase", letterSpacing: 0.5 }}>{h}</th>)}
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {[
                                                ...
                                                <tr key={i} style={{ borderBottom: `1px solid ${BORDER}` }}>
                                                    {row.map((cell, j) => <td key={j} style={{ padding: "10px 12px", color: j === 3 ? "#166534" : j === 0 ? DARK : MUTED, fontWeight: j === 0 ? 600 : 400 }}>{cell}</td>)}
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
